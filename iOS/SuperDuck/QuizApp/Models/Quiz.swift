...
nonisolated struct Quiz: Sendable, Equatable, Identifiable {
    var id: String
    var name: String
    var code: String
...
extension Quiz {
    nonisolated protocol Item: Sendable, Codable {
        var id: String { get }
    ...
    nonisolated struct Section: Equatable, Codable {
        var id: String
        var name: String
        var rows: [Row]
...
nonisolated func areEqual(_ x: Quiz.Item, _ y: Quiz.Item) -> Bool {
...
private extension KeyedDecodingContainer {
    nonisolated func decode(_ type: [Quiz.Item].Type, forKey key: K) throws -> [Quiz.Item] {
...
private extension KeyedEncodingContainer {
    nonisolated mutating func encode(_ items: [Quiz.Item], forKey key: K) throws {
