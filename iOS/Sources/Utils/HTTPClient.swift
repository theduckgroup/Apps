...
struct HTTPClient {
    ...
    func get<T: Decodable>(_ request: URLRequest, decodeAs type: T.Type) async throws -> T {
    ...
    func post(_ request: URLRequest, json: Bool) async throws -> Data {
...
extension HTTPClient {
    struct BadStatusCodeError: LocalizedError {
