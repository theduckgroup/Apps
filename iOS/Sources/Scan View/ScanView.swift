    ...
    private func content() -> some View {
        GeometryReader { geometryProxy in
            ZStack(alignment: .center) {
                BarcodeScanner(
                    minPresenceTime: appDefaults.scanner.minPresenceTime,
                    minAbsenceTime: appDefaults.scanner.minAbsenceTime,
...
private extension InventoryServer {
    func submitItemQuanties(vendorId: String) async throws {
